...
int main(int argc, char** argv, char** env){
	...
	top->en=0b0; top->x=0b01; step_and_dump_wave();
	top->en=0b0; top->x=0b10; step_and_dump_wave();
	top->en=0b0; top->x=0b11; step_and_dump_wave();
	top->en=0b1; top->x=0b00; step_and_dump_wave();
	top->en=0b1; top->x=0b01; step_and_dump_wave();
	top->en=0b1; top->x=0b10; step_and_dump_wave();
	top->en=0b1; top->x=0b11; step_and_dump_wave();
